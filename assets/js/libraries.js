...
/**
 * Check if given parameter is in class list or not
 *
...
/**
 * Remove className from class list
 *
 * @param string {className}
 */
...
Toolkit.Element = {
  ...
  create: function (tag, params) {
    ...
    for (var i in params) {
      this.setParameters(elem, i, params[i]);
    }
    return elem;
  },
   ...
   */
  setParameters: function (elem, attr, value) {
    switch (attr.toLowerCase()) {
      ...
      case 'class':
        ...
        break;
	    case 'html':
        elem.appendChild(document.createTextNode((value != null) ? value : ''));
        break;
      default:
